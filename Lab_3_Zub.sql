...
-- 1
-- example of command reading shp:
-- shp2pgsql -s 4326 D:\SQL_code\Cw3_Karlsruhe_Germany_Shapefile\T2018_KAR_GERMANY\T2018_KAR_BUILDINGS.shp T2018_KAR_BUILDINGS | psql -U postgres -h localhost -p 5432 -d lab3
